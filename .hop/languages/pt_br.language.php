...
define("_SERVER_PROCESSOR_INFO", "Informações dos Processadores");
define("_SERVER_MEMORY_INFO", "Informações de Memória");
define("_SERVER_DISK_INFO", "Informações de Discos");
